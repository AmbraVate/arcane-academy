  ...
  if (!session || session.questions.length === 0) {
    return (
      <div className="flex flex-col items-center justify-center h-[60vh] text-center">
        ...
        <button className="btn btn-primary" onClick={() => navigate('/domains')}>Back to Dashboard</button>
      </div>
    )
  }
  ...
  if (result) {
    ...
    return (
      <div className="max-w-[700px] mx-auto px-4 py-6 pb-[60px] max-[600px]:px-3 max-[600px]:py-4">
        ...
        <button className="btn btn-primary mt-2" onClick={() => navigate('/domains')}>Back to Dashboard</button>
  ...
  return (
    <div className="max-w-[700px] mx-auto px-4 py-6 pb-[60px] max-[600px]:px-3 max-[600px]:py-4">
      ...
      <div className="flex items-center gap-2.5 mb-5 flex-wrap max-[480px]:flex-col max-[480px]:items-start max-[600px]:gap-2">
        <button className="btn btn-ghost text-[12px]" onClick={() => navigate('/domains')}>← Back</button>
