  ...
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        ...
        'w-[90%] max-w-[420px]',
        'bg-card border border-gold-dim rounded-[14px] p-9',
        'text-center',
        'focus:outline-none',
        className
      )}
...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Title
    ref={ref}
    className={cn('font-cinzel text-[28px] text-gold', className)}
    {...props}
  />
))
...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Description
    ref={ref}
    className={cn('text-[15px] text-text leading-[1.7] italic', className)}
    {...props}
  />
))
