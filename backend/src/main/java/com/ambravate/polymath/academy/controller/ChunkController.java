...
import com.ambravate.polymath.academy.service.ChunkGraphService;
import com.ambravate.polymath.academy.service.SpacingService;
...
public class ChunkController {
    ...
    public ResponseEntity<List<ChunkSummaryDto>> getAllChunks(
        ...
        List<ChunkGraphService.ChunkWithStatus> chunks = chunkGraphService.getAllChunksWithStatus(user.getId());
    ...
    public ResponseEntity<ChunkDetailDto> getChunkDetail(
            ...
            @AuthenticationPrincipal UserPrincipal user) {
        List<ChunkGraphService.ChunkWithStatus> allChunks = chunkGraphService.getAllChunksWithStatus(user.getId());
        ChunkGraphService.ChunkWithStatus cws = allChunks.stream()
