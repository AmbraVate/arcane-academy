 ...
 *
 * <p>Trust model: {@link HttpServletRequest#getRemoteAddr()} is the direct
...
public class RateLimitFilter extends OncePerRequestFilter {
    ...
    private record BucketSpec(
        ...
        String identityFromRequest(HttpServletRequest req) { return keyFn.apply(req); }
    }
    ...
    public static class RateLimitProperties {
        ...
        private BucketCfg auth       = new BucketCfg(10, 10, 60);
        private BucketCfg aiMentor   = new BucketCfg(10, 10, 60);
        private BucketCfg codeRunner = new BucketCfg(30, 30, 60);

        public boolean isEnabled() { return enabled; }
        public void setEnabled(boolean enabled) { this.enabled = enabled; }

        public BucketCfg getAuth() { return auth; }
        public void setAuth(BucketCfg auth) { this.auth = auth; }
        public BucketCfg getAiMentor() { return aiMentor; }
        public void setAiMentor(BucketCfg aiMentor) { this.aiMentor = aiMentor; }
        public BucketCfg getCodeRunner() { return codeRunner; }
        public void setCodeRunner(BucketCfg codeRunner) { this.codeRunner = codeRunner; }
        ...
        public static class BucketCfg {
            ...
            public BucketCfg() {}
            public BucketCfg(long capacity, long refillTokens, long refillPeriodSeconds) {
            ...
            public long refillPeriodSeconds() { return refillPeriodSeconds; }
