...
public class Ch1Seeder extends AbstractChapterSeeder {
    ...
    public void seed() {
        ...
        q("ch1-q1","The Wall of First Words","Chapter I · Quest 1","Hello World",1,1,80,"HelloWorld.java",
          story(
            n("You push open the great oak doors of Polymath Academy. The entrance hall is vast and dimly lit by floating orbs of blue light. At the far end stands an enormous stone wall — the <em>Wall of First Words</em> — covered floor to ceiling in glowing text."),
          ...
          "Add <strong>one line</strong> inside the <code>main</code> method that prints exactly:<br><strong>Welcome to Polymath Academy!</strong>",
          "Type inside the curly braces: <code>System.out.println(\"Welcome to Polymath Academy!\");</code>",
          ...
          tests(test("Output","null","Welcome to Polymath Academy!")));
        ...
        sq("ch1-sq2","The Rune Taxonomy","Chapter I · Side Quest","Primitive vs Reference Types",1,91,60,"RuneTaxonomy.java",
          ...
          "Demonstrate both worlds with <code>int power = 9000</code>, <code>boolean transformed = power &gt; 8000</code>, <code>char initial = 'A'</code> — print each on its own line. Then <code>String school = \"Polymath Academy\"</code> — print its <code>length()</code> and the result of <code>school.indexOf(\"Academy\")</code>.",
