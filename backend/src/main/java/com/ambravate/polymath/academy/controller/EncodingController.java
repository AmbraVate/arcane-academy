...
public class EncodingController {
    ...
    public ResponseEntity<SubChunkEncodingDto> startSubChunk(
        ...
        EncodingService.SubChunkSession session = encodingService.startSubChunk(user.getId(), subChunkId);
    ...
    public ResponseEntity<SubChunkEncodingDto> advancePhase(
            @PathVariable String subChunkId,
            @AuthenticationPrincipal UserPrincipal user) {
        EncodingService.SubChunkSession session = encodingService.advancePhase(user.getId(), subChunkId);
    ...
    public ResponseEntity<SubmitResponse> submitGuidedPractice(
            ...
            @AuthenticationPrincipal UserPrincipal user) {
        EncodingService.PracticeResult result = encodingService.submitGuidedPractice(
    ...
    public ResponseEntity<RetrievalResultDto> submitRetrievalCheck(
        ...
        EncodingService.RetrievalCheckResult result = encodingService.submitRetrievalCheck(
    ...
    public ResponseEntity<FeynmanResultDto> submitFeynman(
            ...
            @AuthenticationPrincipal UserPrincipal user) {
        FeynmanService.FeynmanResult result = feynmanService.evaluateExplanation(
    ...
    private SubChunkEncodingDto toDto(EncodingService.SubChunkSession session) {
