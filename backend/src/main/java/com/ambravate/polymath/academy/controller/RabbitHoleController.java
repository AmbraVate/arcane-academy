...
import com.ambravate.polymath.academy.service.EncodingService;
import com.ambravate.polymath.academy.service.RabbitHoleService;
...
public class RabbitHoleController {
    ...
    public ResponseEntity<SubmitResponse> submitCode(
        ...
        EncodingService.PracticeResult result = rabbitHoleService.submitCode(user.getId(), moduleId, request.getCode());
